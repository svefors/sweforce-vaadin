...
//     */
//    public Localizer(LocaleService localeService) {
...
//     * @param component The component to get the resource for
//     * @return The string resource
//     * @throws MissingResourceException If resource not found and configuration dictates that exception should be thrown
...
//     * @param key       The key to obtain the resource for
//     * @param component The component to get the resource for
//     * @param model     The model to use for property substitutions in the strings (optional)
//     * @return The string resource
//     * @throws MissingResourceException If resource not found and configuration dictates that exception should be thrown
//     * @see #getString(String, Component, IModel, Locale, String, String)
//     */
...
//     * @param model        The model to use for substitutions in the strings (optional)
//     * @param locale       If != null, it'll supersede the component's locale
//     * @param style        If != null, it'll supersede the component's style
//     * @param defaultValue The default value (optional)
//     * @return The string resource
//     * @throws MissingResourceException If resource not found and configuration dictates that exception should be thrown
//     */
//    public String getString(final String key, final Component component, final Item model,
...
//
//
//    public final <T extends Component> T findParent(Component component, Class<? extends T> parentType) {
//        HasComponents parent = component.getParent();
//        if (parent == null) {
//            return null;
//        } else if (parent instanceof parentType) {
//            return (T) parent;
//        } else {
//            return findParent(component, parentType);
//        }
//    }
//
//    /**
...
//     */
//    public final String getStringIgnoreSettings(final String key, final Component component,
//                                                final Item item, Locale locale, String style, final String defaultValue) {
//        boolean addedToPage = false;
//        if (component != null) {
//            if ((component instanceof UI) || (null != findParent(component, UI.class))) {
//
//                addedToPage = true;
//            }
//
...
//            cacheKey = getCacheKey(key, component, locale, style, null /* variation */);
//        }
//
...
//     * @param key
//     * @param component
//     * @param locale    Guaranteed to be != null
//     * @param style
//     * @param variation
//     * @return The value of the key
//     */
...
//     *
//     * @param component The component requesting a model value or {@code null]
