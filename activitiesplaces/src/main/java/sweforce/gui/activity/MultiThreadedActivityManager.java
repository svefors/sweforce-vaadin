 ...
 */
@Deprecated
public class MultiThreadedActivityManager implements PlaceChangeEvent.Handler, PlaceChangeRequestEvent.Handler {

    private static Logger logger = LoggerFactory.getLogger(MultiThreadedActivityManager.class);
    ...
    private class ProtectedDisplay implements Display {
        ...
        public void setView(View view) {
            if (this.activity == MultiThreadedActivityManager.this.currentActivity) {
                startingNext = false;
                showWidget(view);
            }
        }
    ...
    */
     ...
     *                 {@link sweforce.gui.place.Place}
     * @param eventBus source of {@link PlaceChangeEvent} and
     *                 {@link PlaceChangeRequestEvent} events.
     */
    public MultiThreadedActivityManager(ActivityMapper mapper, EventBus eventBus) {
        this.mapper = mapper;
